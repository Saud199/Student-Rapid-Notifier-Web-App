...
import './Student ViewAchievements.css';
...
class StudentViewAchievements extends Component {
...
export default connect(mapStateToProp, mapDispatchToProp)(StudentViewAchievements);